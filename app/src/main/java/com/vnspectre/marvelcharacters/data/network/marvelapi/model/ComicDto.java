...
public class ComicDto {
    ...
    private ComicResourceDto series;

    @SerializedName("variants")
    private List<MarvelResourceDto> variants;

    @SerializedName("collections")
    private List<MarvelCollection> collections;

    @SerializedName("collectedIssues")
    private List<MarvelCollection> collectedIssues;
    ...
    private MarvelResources<CreatorResourceDto> creators;

    @SerializedName("characters")
    private MarvelResources<CharacterResourceDto> characters;
