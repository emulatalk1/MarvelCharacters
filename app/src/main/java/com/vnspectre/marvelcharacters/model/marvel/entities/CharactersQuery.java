...
public class CharactersQuery {
    ...
    private CharactersQuery(String name, String nameStartWith, String modifiedSince,
                            String comics, String series, String events, String stories,
    ...
    public static class Builder {
        ...
        public Builder withModified(Date modifiedSice) {
            this.modifiedSice = modifiedSice;
            return this;
        }
        ...
        public CharactersQuery build() {
            String plainModifiedSince = convertDate(modifiedSice);
            ...
            return new CharactersQuery(name, nameStartWith, plainModifiedSince,
        ...
        private void checkOffset(int offset) {
            if (offset <= 0) {
                throw new IllegalArgumentException("Offset must be bigger than zero");
            }
        }
        ...
        private void checkNull(List<Integer> list) {
            if (list == null) {
                throw new IllegalArgumentException("This collection can not be null");
            }
        }
    }
